        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400">
              Your trusted source for insightful articles, news, and stories that matter.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/category/travel" className="text-gray-400 hover:text-white transition">Travel</Link></li>
              <li><Link to="/category/food" className="text-gray-400 hover:text-white transition">Food</Link></li>
            </ul>
          </div>
